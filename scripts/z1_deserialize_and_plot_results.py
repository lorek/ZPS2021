...
def ParseArguments():
    ...
    parser.add_argument('--input-file', default = 'results/z1_XORG_numbers_int/z1_XORG_numbers_int_0.pkl', required = False, help = 'File with numbers stored as pickle (default: %(default)s)')
